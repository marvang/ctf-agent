...
def run_experiment_agent(
    ...
    try:
        while True:
            ...
            if usage:
                ...
                if chap_enabled:
                    ...
                    token_limit_for_agent = chap_token_limit_base + (
                        session["agent_number"] * chap_token_limit_increment
                    )
        ...
        error_message = error_message or "Experiment interrupted by user"
